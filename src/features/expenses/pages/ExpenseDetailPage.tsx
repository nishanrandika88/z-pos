    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[2fr_1fr]">
        <div className="space-y-4">
          ...
          {expense.categoryDetails ? <Card><CardHeader><h2 className="font-semibold">Category details</h2></CardHeader><CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">{expense.categoryDetails.periodStart ? <Info label="Period start" value={expense.categoryDetails.periodStart} /> : null}{expense.categoryDetails.periodEnd ? <Info label="Period end" value={expense.categoryDetails.periodEnd} /> : null}{expense.categoryDetails.utilityType ? <Info label="Utility type" value={expense.categoryDetails.utilityType} /> : null}{expense.categoryDetails.accountNumber ? <Info label="Account number" value={expense.categoryDetails.accountNumber} /> : null}{expense.categoryDetails.dueDate ? <Info label="Due date" value={expense.categoryDetails.dueDate} /> : null}{expense.categoryDetails.paymentDate ? <Info label="Payment date" value={expense.categoryDetails.paymentDate} /> : null}{expense.categoryDetails.equipmentDetails ? <Info label="Equipment / repair" value={expense.categoryDetails.equipmentDetails} /> : null}{expense.categoryDetails.serviceDate ? <Info label="Purchase / service date" value={expense.categoryDetails.serviceDate} /> : null}{expense.categoryDetails.warrantyInformation ? <Info label="Warranty" value={expense.categoryDetails.warrantyInformation} /> : null}</CardContent></Card> : null}
